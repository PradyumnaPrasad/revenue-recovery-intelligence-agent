...
### 1.1 The thirteen defects found in the code audit and real execution
...
("actions execute for real") the whole system exists to prove. All
thirteen are fixed and verified live.
